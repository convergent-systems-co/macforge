#!/bin/bash
# Pinned snapshot of Homebrew's official installer.
# Source: https://raw.githubusercontent.com/Homebrew/install/master/install.sh
# Fetched: 2026-05-20
#
# Refresh procedure:
#   1. curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh > internal/embedded/scripts/install-brew.sh
#   2. Restore this header block at the top.
